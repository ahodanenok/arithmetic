...
public class InfixNotationTest {

    @Test
    public void testAstBinaryOp() {
        // 1 + 2
        InfixNotationAstBuilder builder = new InfixNotationAstBuilder();
        Env env = new Env();
    ...
    public void testFnEval_UnknownOp() {
        Arithmetic arithmetic = Arithmetic.create(Notation.INFIX);
    ...
    public void testOpEval() {
        ...
        assertEquals(new BigDecimal(28), arithmetic.evaluate("( 10  - 2) *  3 + 4"));
        assertEquals(new BigDecimal(8), arithmetic.evaluate("10 - 2 *3 +4"));
        assertEquals(new BigDecimal(-4), arithmetic.evaluate("10 - 2 *(3 +4)"));
    ...
    public void testAstBinaryFn() {
        ...
        builder.addToken(new Token(TokenType.LP));
        builder.addToken(new Token(TokenType.NUMBER, "2"));
        builder.addToken(new Token(TokenType.COMMA));
        builder.addToken(new Token(TokenType.NUMBER, "5"));
        builder.addToken(new Token(TokenType.RP));
        Expression expression = builder.build();
